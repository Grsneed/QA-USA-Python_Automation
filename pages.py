...
class UrbanRoutesPage:
    ...
    TO_FIELD  = (By.ID, 'to')
     #Tariff
    CUSTOM_OPTION_BUTTON_LOCATOR = (By.XPATH, '//div[text()="Custom"]')
    ...
    PHONE_NUMBER_TOUCH_LOCATOR = (By.XPATH, '//div[text()= "Phone number")]')
    ...
    def click_supportive_plan(self):
        self.driver.find_element(*SUPPORTIVE_LOCATOR).click()
    ...
    def enter_card_code(self):
        self.drver.find_element(*self.CARD_CODE_LOCATOR).send_keys(card_code)
